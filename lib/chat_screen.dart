      ...
      if (_.isRequest) {
        if (_.img != null) {
          return MeChatWithImageWidget(
              img: _.img!, username: 'You', msg: _.msg, time: time);
        }
        return MeChatWidget(username: 'You', msg: _.msg, time: time);
      }
      return ResponseChatWidget(username: 'Gemini', msg: _.msg, time: time);
    }).toList();
